#!/usr/bin/env python3
"""
Extinction opportunity cost: imported vs domestically produced, mirrored about zero.

Replaces plotting/Fig2internal_external_recreation.py.

    python plotting/life_extinctions/internal_external.py --countries GBR USA CHN
"""
