#!/usr/bin/env python3
"""
Production greenhouse gas emissions per capita per day, stacked by commodity group, one panel per country.

Replaces plotting/Fig2recreation.py.

    python plotting/ghgs/group_timeseries.py --countries GBR USA CHN
"""
